...
require_once($CFG->dirroot . '/mod/flexible/backup/moodle2/restore_flexible_stepslib.php'); // Because it exists (must)

class restore_flexible_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_flexible_activity_structure_step('flexible_structure', 'flexible.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('flexible', array('intro'), 'flexible');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('ASSIGNMENTVIEWBYID', '/mod/flexible/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('ASSIGNMENTINDEX', '/mod/flexible/index.php?id=$1', 'course');
