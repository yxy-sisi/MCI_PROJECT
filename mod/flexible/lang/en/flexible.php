...
$string['modulename_help'] = "The Flexible assignment module allows teachers to develop single task or variations of task, collect work from students, review it and provide feedback including multi-criterion grades. Module can distribute multiple task�s variants between students in different ways, using one of distribution strategies.";
$string['submissionoptions'] = 'Submission options';
$string['modulenameplural'] = 'Flexible assignments';
$string['flexiblefieldset'] = 'Individual tasks';
$string['flexiblename'] = 'Flexible assignment name';
$string['flexible'] = 'Flexible assignment';
$string['flexibleintro'] = 'Flexible assignment intro';
$string['pluginname'] = 'Flexible assignment';
$string['taskdescription'] = 'Task description';
$string['flexibleadministration'] = 'Administration';
...
$string['flexiblefiles'] = 'Attach file(s) to the assignment';
$string['attachedflexiblefiles'] = 'File(s) attached to the assignment';
...
$string['flexiblegraderslist'] = 'Graders that will be used in this module';
...
$string['defaultintro'] = ' Flexible assignment example';
...
$string['flexible:addinstance'] = 'Ability to create new instances';
$string['flexible:finalgrades'] = 'Ability to finalize grades';
$string['flexible:grade'] = 'Ability to grade student\'s work';
$string['flexible:manageanything'] = 'Ability to do anything';
$string['flexible:managecriterions'] = 'Ability to manage criterions';
$string['flexible:managetasks'] = 'Ability to manage tasks';
$string['flexible:seecriteriondescription'] = 'Ability to see criterions descriptions';
$string['flexible:seefielddescription'] = 'Ability to see fields description';
$string['flexible:seeotherstasks'] = 'Ability to see other tasks';
$string['flexible:selectowntask'] = 'Ability to select own task';
$string['flexible:havetask'] = 'Ability to submit';
$string['flexible:view'] = 'Ability to view module instance';
$string['flexible:viewownsubmission'] = 'Ability to view own submissions';
...
$string['flexibleadditional'] = 'Additional subplugins';
...
$string['flexiblefiles_help'] = 'Instance files';
...
$string['subplugintype_flexible_plural'] = 'Graders';
$string['subplugintype_flexibleanswertypes_plural'] = 'Answer types';
$string['subplugintype_flexibletaskgivers_plural'] = 'Task givers';
$string['subplugintype_flexibleadditional_plural'] = 'Additionl plugins';
$string['flexibleplugins'] = 'Flexible Assignment plugins';