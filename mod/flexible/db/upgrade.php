...
/**
 * This file keeps track of upgrades to the flexible module
 *
...
/**
 * xmldb_flexible_upgrade
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_flexible_upgrade($oldversion=0) {
...
/// for demonstrative purposes and to show how the flexible
/// iself has been upgraded.

/// For each upgrade block, the file flexible/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to flexible
        $table = new XMLDBTable('flexible');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to flexible
        $table = new XMLDBTable('flexible');
    ...
    /// Define field introformat to be added to flexible
        $table = new XMLDBTable('flexible');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to flexible
        $table = new XMLDBTable('flexible');
    ...
    /// Define field timemodified to be added to flexible
        $table = new XMLDBTable('flexible');
    ...
    /// Define index course (not unique) to be added to flexible
        $table = new XMLDBTable('flexible');
